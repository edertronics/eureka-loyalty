      ...
      <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', background: PRIMARY }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 300 }}>
          ...
          <div className="success-header">
            {business.logo_url && (
              <img src={business.logo_url} alt={business.name} style={{ height: 36, width: 'auto', marginBottom: 16, objectFit: 'contain', display: 'block', margin: '0 auto 16px' }} />
            )}
            {!business.logo_url && (
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 16px', background: PRIMARY }}>
      ...
      <div style={{ marginBottom: 32, textAlign: 'center' }}>
        {business.logo_url
          ? <img src={business.logo_url} alt={business.name} style={{ height: 83, width: 'auto', objectFit: 'contain', display: 'block', margin: '0 auto' }} />
